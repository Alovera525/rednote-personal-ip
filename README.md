...
| 步骤 | 做什么 | 关键判断 |
|---|---|---|
| 0 · 定风格 | 从行业相关风格卡建立风格 DNA | 先有稳定表达底座，再用反馈校准成本人 |
...
首次使用不再强制提交 3–5 段微信。Skill 会根据行业 / 身份推荐 4–6 张风格卡，让用户选择主风格、可选辅助风格和明确不要的风格，再用同一主题的三段短样稿完成校准。

内置 12 种风格母型：冷静拆解、犀利前辈、反常识观点、真实测评、买手筛选、在地侦察、闺蜜口述、温柔陪伴、场景故事、成长日记、高能教练和审美策展。风格和行业分开组合，例如“学生博主 × 成长日记”或“情感博主 × 温柔陪伴”。

声音档案会从风格选择、标题 / 样稿选择、明确反馈和用户改稿中持续学习；没有制作图片也会更新文字偏好。自然语料仍可用于增强，但不再是前置条件。
